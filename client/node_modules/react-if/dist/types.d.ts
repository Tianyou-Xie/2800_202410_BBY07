 ...
 */
export type ComponentWithConditionPropsWithFunctionChildren<P = NonNullObject> = P & CustomPropsWithChildren<{
 ...
 * as well as a `condition` prop that is supported by this library
 */
export type ComponentWithConditionProps<P = NonNullObject> = P & PropsWithChildren<{
    condition: (() => BooleanLike) | BooleanLike;
}>;
/**
 * Async related props
